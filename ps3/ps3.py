...
#    print(word)
#    n = hand_size - len(word_lower)
    word_value = []
    for letter in word:
        word_value.append(SCRABBLE_LETTER_VALUES.get(letter))
#    print(word_value)
    first_comp = sum(word_value)
#    print(first_comp)
    second_comp = 7 * len(word) - 3 * (n - len(word))
    if second_comp >= 1:
        res = first_comp*second_comp
    else:
        res = first_comp * 1
#    print(second_comp)
    return res

#print(get_word_score('ap', 7))
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    sub = str.lower(input("Would you like to substitute a letter? (enter 'yes' or 'no'): "))
    if sub == 'yes':
    ...
    # so tell user the total score
        ...
        print("Ran out of letters. Total:", total_score, "points")
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    total_score = 0
    n = 7
    # step 1, determine hand number
    hand_no = input("Enter total number of hands: ")
    while hand_no.isdigit() == False:
        hand_no = input("That is not an integer. Enter total number of hands: ")
    hand_no = int(hand_no)
    # step 2, iterate game according to hand number
    while hand_no > 0:    
            # play_hand once, and calculate total_score
        hand = deal_hand(n)
        hand_score = 0
        print("Current hand:", display_hand(hand))
        ...
        # ask for replay hand
        replay = str.lower(input("Would you like to replay the hand?  (enter 'yes' or 'no'): "))
        if replay == 'yes':
            hand_score = 0
            print("Current hand:", display_hand(hand))
            hand_score = play_hand(hand, word_list)
